...
function App() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (loginForm.email === 'Chappy98st@gmail.com' && loginForm.password === 'KvM78963!') {
  ...
  const handleAddLineup = (e: React.FormEvent) => {
    e.preventDefault();
    
    // Validate form
    if (!newLineup.title.trim() || !newLineup.videoUrl.trim()) {
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <form onSubmit={handleAddLineup} className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="title"
                    value={newLineup.title}
                    onChange={(e) => setNewLineup(prev => ({ ...prev, title: e.target.value }))}
                    className="w-full bg-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="map" className="block text-sm font-medium text-gray-400 mb-1">
                      Map
                    </label>
                    <select
                      id="map"
                      value={newLineup.map}
                      onChange={(e) => setNewLineup(prev => ({ ...prev, map: e.target.value as MapType }))}
                      className="w-full bg-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    >
                      <option value="mirage">Mirage</option>
                      <option value="dust2">Dust 2</option>
                  ...
                  <div>
                    ...
                    <select
                      id="type"
                      value={newLineup.type}
                      onChange={(e) => setNewLineup(prev => ({ ...prev, type: e.target.value as GrenadeType }))}
                      className="w-full bg-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    >
                      <option value="smoke">Smoke</option>
                      <option value="flash">Flash</option>
                  ...
                  <div>
                    ...
                    <select
                      id="position"
                      value={newLineup.position}
                      onChange={(e) => setNewLineup(prev => ({ ...prev, position: e.target.value as Position }))}
                      className="w-full bg-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    >
                      <option value="A Site">A Site</option>
                      <option value="B Site">B Site</option>
                      <option value="Mid">Mid</option>
                      <option value="CT Spawn">CT Spawn</option>
                      <option value="T Spawn">T Spawn</option>
                  ...
                  <div>
                    <label htmlFor="site" className="block text-sm font-medium text-gray-400 mb-1">
                      Site
                    </label>
                    <select
                      id="site"
                      value={newLineup.site}
                      onChange={(e) => setNewLineup(prev => ({ ...prev, site: e.target.value as Site }))}
                      className="w-full bg-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    >
                      <option value="A Site">A Site</option>
                      <option value="B Site">B Site</option>
                ...
                <div>
                  ...
                  <input
                    type="url"
                    id="videoUrl"
                    value={newLineup.videoUrl}
                    onChange={(e) => setNewLineup(prev => ({ ...prev, videoUrl: e.target.value }))}
                    className="w-full bg-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  <button
                    type="submit"
                    className="bg-green-500 hover:bg-green-600 px-6 py-2 rounded-lg transition-colors font-medium"
                  >
                    Add Lineup
                  </button>
                </div>
